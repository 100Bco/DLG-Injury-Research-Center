/**
 * Global site configuration. Kept minimal and neutral — this is a research
 * reference tool, not a marketing site.
 */
export const site = {
  name: 'Texas Injury Data Directory',
  shortName: 'TX Injury Data',
  // One line: what the site is + who it's for.
  tagline:
